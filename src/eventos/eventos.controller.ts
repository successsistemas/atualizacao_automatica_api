...
export class EventosController {
  ...
  @UseGuards(JwtAuthGuard)
  getEvento(
    @CurrentUser() usuario: UsuarioBody,
    @Param('evento_id') id: number
  ) {
  ...
  getEventByTitulo(
    ...
    return this.eventosService.findByTitulo(
      parametro?.titulo,
      dataInicial,
      dataFinal
    )
